...
const { loginRequestSchema, ssoTokenSchema } = require('./validator');
 ...
 *            example:
 *               {
                        "token": "d79305c9-1e66-4c45-b7be-9977120d8bcc",
                  }
 *     produces:
 *       - application/json
 *     responses:
...
router.post(
  '/sso-login',
  validator(ssoTokenSchema),
  loginController.acceptSsoToken,
);
